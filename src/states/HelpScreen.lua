...
function HelpMenu:init(params)
	...
	"Marathon challenges you with getting as high of a score as possible while playing until you reach level 15.\n\nSprint has you attempting to get as high of a score as possible before you've reached 50 lines cleared.\n\nEndless is just that, you play until you get a game over.\n\nThen after getting a game over or completing the game mode you will be given the option to enter your name for the high score table. There is one for each difficulty and game mode. Your name must be no more than 10 characters in length.\n\nThere is an Easy Mode and a Hard/Classic Mode.\n\nYou get a game over by having a piece be locked in place above the top of the visible game window. The other way is to complete the specific conditions laid out in the game mode.",
		...
		'Sprint Mode tasks you with getting the maximum score within the first 50 lines of the game. This is a mode to quickly get into a game and practice your abilities to buildup combos.',
		'Endless mode is all about playing until game over.\nThe game will no end until you have no more valid moves in the game or a piece is locked above the game board thus making the spawning of the next piece impossible. Note that all levels beyond 15 rapidly increase in difficulty due to the pieces moving more and more rapidly.',
